...
ACTION_PATTERNS = (
    ...
    ("PLACE", r"放到|放在|摆到|置于|放入|放进|装入|放置|放好|归位到|归位于|归位进", 0.93, "action.place"),
...
ACTION_PATTERNS = ACTION_PATTERNS + (
    ...
    ("PLACE", r"(?:\u5b89\u987f\u5230|\u5b89\u7f6e\u5230|\u843d\u5728|\u5f52\u7f6e\u8fdb|\u5f52\u5165|\u5f52\u4f4d\u5230|\u5f52\u4f4d\u4e8e|\u5f52\u4f4d\u8fdb|\u7a33\u59a5\u5730\u5b89\u653e|\u5728[^，。；,;]{0,10}\u4e0a\u5c31\u4f4d|\u8f6c\u624b\u653e\u5165|\u6536\u8fdb|\u843d\u4f4d|\u6446\u653e\u59a5\u5f53|\u653e\u597d|\u4ea4\u7ed9[^，。；,;]{0,8}\u627f\u6258|\u5b89\u653e\u4e8e|\u653e\u56de[^，。；,;]{0,8}\u627f\u8f7d)", 0.94, "action.place.open"),
    ("PLACE", r"(?:\u5e2e\u6211)?(?:\u5b8c\u6210|\u8fdb\u884c|\u6267\u884c)\s*[^，。；,;]{1,24}?(?:的)?(?:\u653e\u7f6e|\u653e\u597d)", 0.94, "action.place.nominal"),
