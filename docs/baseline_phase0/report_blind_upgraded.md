...
| 6. Conditional/Sequential Understanding | 8.3% | 12 | 0 | 11 |
...
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b16a, actual=obj-f92641
- Execution: expected=True, actual=True
- [CRITICAL] **negation_constraint_retention**: Negation/avoid 'obj-b16b' not propagated to BT/CG (expected=obj-b16b, actual=['cup'])
...
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b20a, actual=obj-199f3e
- Execution: expected=True, actual=True
- [CRITICAL] **negation_constraint_retention**: Negation/avoid 'obj-b20b' not propagated to BT/CG (expected=obj-b20b, actual=['cup', 'obj-a363e5'])

### ❌ B33 [roles]: 把盒子拿过来，别碰玻璃杯
- Action: expected=FETCH, actual=FETCH
- Entity: expected=obj-b33a, actual=obj-0da41b
- Execution: expected=False, actual=False
- [CRITICAL] **negation_constraint_retention**: Negation/avoid 'obj-b33b' not propagated to BT/CG (expected=obj-b33b, actual=['box', 'cup', 'obj-b2d48b'])
...
- Entity: expected=obj-b38a, actual=obj-bd46f4
...
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b39a, actual=obj-3575bb
- Execution: expected=True, actual=True
- [CRITICAL] **negation_constraint_retention**: Negation/avoid 'obj-b39b' not propagated to BT/CG (expected=obj-b39b, actual=['box', 'obj-6a01b1'])

### ❌ B41 [negation_condition]: 把盒子拿过来，千万别碰玻璃杯
- Action: expected=FETCH, actual=FETCH
- Entity: expected=obj-b41a, actual=obj-26ab3e
- Execution: expected=False, actual=False
- [CRITICAL] **negation_constraint_retention**: Negation/avoid 'obj-b41b' not propagated to BT/CG (expected=obj-b41b, actual=['box', 'cup', 'obj-72fc9e'])
...
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b46, actual=obj-5a69cb
- Execution: expected=True, actual=True
...
- Entity: expected=obj-b48a, actual=obj-4af112
...
- Action: expected=FETCH, actual=FETCH
- Entity: expected=obj-b50c, actual=obj-92f1ef
- Execution: expected=False, actual=False
- [CRITICAL] **negation_constraint_retention**: Negation/avoid 'obj-b50a' not propagated to BT/CG (expected=obj-b50a, actual=['cup', 'obj-b8c8bc', 'obj-e3bb9c'])
- [CRITICAL] **negation_constraint_retention**: Negation/avoid 'obj-b50b' not propagated to BT/CG (expected=obj-b50b, actual=['cup', 'obj-b8c8bc', 'obj-e3bb9c'])

### ⚠️ B54 [numeric_constraints]: 用3到5N的力量抓住杯子
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b54, actual=obj-317859
- Execution: expected=True, actual=False
...
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b62, actual=obj-12e1ca
- Execution: expected=True, actual=False
- [HIGH] **conditional_sequential_understanding**: Plan status inconsistent with execution_allowed (expected=READY or READY_WITH_SAFE_SUBSTITUTION, actual=BLOCKED)

### ⚠️ B64 [robot_state]: 抓住很重的铁块
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b64, actual=obj-33352e
- Execution: expected=True, actual=False
- [HIGH] **conditional_sequential_understanding**: Plan status inconsistent with execution_allowed (expected=READY or READY_WITH_SAFE_SUBSTITUTION, actual=BLOCKED)

### ⚠️ B70 [robot_state]: 把杯子夹住并翻转过来
- Action: expected=CUSTOM, actual=GRASP
- Entity: expected=obj-b70, actual=obj-0cb529
- Execution: expected=True, actual=True
...
- Action: expected=PLACE, actual=PLACE
- Entity: expected=obj-b87a, actual=obj-d5833f
- Execution: expected=True, actual=False
...
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b88a, actual=obj-522939
- Execution: expected=True, actual=True
- [CRITICAL] **negation_constraint_retention**: Negation/avoid 'obj-b88b' not propagated to BT/CG (expected=obj-b88b, actual=['obj-c3f1cf', 'table'])
...
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b90, actual=obj-c7e44f
- Execution: expected=True, actual=False
- [HIGH] **conditional_sequential_understanding**: Plan status inconsistent with execution_allowed (expected=READY or READY_WITH_SAFE_SUBSTITUTION, actual=BLOCKED)
...
- Action: expected=, actual=GRASP
- Entity: expected=None, actual=obj-3a1641
- Execution: expected=True, actual=False
- [HIGH] **conditional_sequential_understanding**: Plan status inconsistent with execution_allowed (expected=READY or READY_WITH_SAFE_SUBSTITUTION, actual=BLOCKED)
...
- Action: expected=GRASP, actual=GRASP
- Entity: expected=obj-b108a, actual=obj-096fbb
- Execution: expected=True, actual=True
