...
$traceValues = @{
    ...
    TRACECODER_ADAPTIVE_ROUTING = (Get-LocalEnvValue $tracePath "TRACECODER_ADAPTIVE_ROUTING")
    ...
    TRACECODER_LEGACY_MAX_TOKENS = (Get-LocalEnvValue $tracePath "TRACECODER_LEGACY_MAX_TOKENS")
    TRACECODER_LEGACY_THINKING = (Get-LocalEnvValue $tracePath "TRACECODER_LEGACY_THINKING")
    TRACECODER_LEGACY_REASONING_EFFORT = (Get-LocalEnvValue $tracePath "TRACECODER_LEGACY_REASONING_EFFORT")
    TRACECODER_LEGACY_MAX_RETRIES = (Get-LocalEnvValue $tracePath "TRACECODER_LEGACY_MAX_RETRIES")
    TRACECODER_LEGACY_MAX_REPAIR_ATTEMPTS = (Get-LocalEnvValue $tracePath "TRACECODER_LEGACY_MAX_REPAIR_ATTEMPTS")
    TRACECODER_LEGACY_OPTIMIZE_QUALITY = (Get-LocalEnvValue $tracePath "TRACECODER_LEGACY_OPTIMIZE_QUALITY")
}
...
if (-not $traceValues.TRACECODER_ADAPTIVE_ROUTING) { $traceValues.TRACECODER_ADAPTIVE_ROUTING = "adaptive" }
if (-not $traceValues.TRACECODER_LEGACY_MAX_TOKENS) { $traceValues.TRACECODER_LEGACY_MAX_TOKENS = "8192" }
if (-not $traceValues.TRACECODER_LEGACY_THINKING) { $traceValues.TRACECODER_LEGACY_THINKING = "enabled" }
if (-not $traceValues.TRACECODER_LEGACY_REASONING_EFFORT) { $traceValues.TRACECODER_LEGACY_REASONING_EFFORT = "low" }
if (-not $traceValues.TRACECODER_LEGACY_MAX_RETRIES) { $traceValues.TRACECODER_LEGACY_MAX_RETRIES = "2" }
if (-not $traceValues.TRACECODER_LEGACY_MAX_REPAIR_ATTEMPTS) { $traceValues.TRACECODER_LEGACY_MAX_REPAIR_ATTEMPTS = "2" }
if (-not $traceValues.TRACECODER_LEGACY_OPTIMIZE_QUALITY) { $traceValues.TRACECODER_LEGACY_OPTIMIZE_QUALITY = "true" }
...
Write-EnvFile $tracePath $traceValues @(
    "TRACECODER_LLM_MODE", "TRACECODER_ADAPTIVE_ROUTING", "TRACECODER_LLM_MODEL", "TRACECODER_LLM_BASE_URL",
    ...
    "TRACECODER_EXPERT_OPTIMIZE_QUALITY", "TRACECODER_LEGACY_MAX_TOKENS", "TRACECODER_LEGACY_THINKING",
    "TRACECODER_LEGACY_REASONING_EFFORT", "TRACECODER_LEGACY_MAX_RETRIES", "TRACECODER_LEGACY_MAX_REPAIR_ATTEMPTS",
    "TRACECODER_LEGACY_OPTIMIZE_QUALITY"
) "# Generated by tools/setup.ps1; local only."
